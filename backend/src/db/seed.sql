-- ShopVault Seed Data
-- Default admin password: admin123 (bcrypt hash for 12 rounds)
...
(
    'Admin',
    'admin@shopvault.com',
    '$2b$12$jmv/SQN23fCMcsJA5X8pJesr9r8l8SB2W4mnuQ5.6eoIV23wa1GtC',
    'admin'
);
...
-- PRODUCTS
-- ============================================
INSERT INTO products (name, price, category, emoji, rating, reviews, description, colors, features, in_stock) VALUES
(
